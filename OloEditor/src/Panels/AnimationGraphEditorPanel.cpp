...
namespace OloEngine
{
	...
	void AnimationGraphEditorPanel::DrawParameterEditor()
	{
		...
		for (auto& [name, param] : graph->Parameters.GetAll())
		{
			...
			{
			case AnimationParameterType::Float:   typeLabel = "Float"; break;
			case AnimationParameterType::Int:      typeLabel = "Int"; break;
			case AnimationParameterType::Bool:     typeLabel = "Bool"; break;
			case AnimationParameterType::Trigger:  typeLabel = "Trigger"; break;
			}
		...
		if (m_ShowNewParamDialog)
		{
			...
			if (ImGui::Button("Create") && strlen(m_NewParamName) > 0)
			{
				...
				{
				case 0: graph->Parameters.DefineFloat(name, m_NewParamDefaultFloat);
				        graphComp.Parameters.DefineFloat(name, m_NewParamDefaultFloat); break;
				case 1: graph->Parameters.DefineInt(name, m_NewParamDefaultInt);
				        graphComp.Parameters.DefineInt(name, m_NewParamDefaultInt); break;
				case 2: graph->Parameters.DefineBool(name, m_NewParamDefaultBool);
				        graphComp.Parameters.DefineBool(name, m_NewParamDefaultBool); break;
				case 3: graph->Parameters.DefineTrigger(name);
				        graphComp.Parameters.DefineTrigger(name); break;
				}
	...
	void AnimationGraphEditorPanel::DrawTransitionEditor()
	{
		...
		if (m_SelectedTransitionIndex >= 0 && m_SelectedTransitionIndex < static_cast<i32>(transitions.size()))
		{
			...
			for (auto const& cond : t.Conditions)
			{
				...
				switch (cond.Op)
				{
				case TransitionCondition::Comparison::Greater:    opStr = ">"; break;
				case TransitionCondition::Comparison::Less:       opStr = "<"; break;
				case TransitionCondition::Comparison::Equal:      opStr = "=="; break;
				case TransitionCondition::Comparison::NotEqual:   opStr = "!="; break;
				case TransitionCondition::Comparison::TriggerSet: opStr = "Trigger"; break;
				}
