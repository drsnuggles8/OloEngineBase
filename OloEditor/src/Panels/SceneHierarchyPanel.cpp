...
namespace OloEngine
{
    ...
    void SceneHierarchyPanel::DrawComponents(Entity entity)
    {
        ...
        DrawComponent<LODGroupComponent>("LOD Group", entity, [entity](auto& component)
            ...
            ImGui::Separator();
            // Nothing in this panel touches m_AutoGenerated. The scene serializer
            // decides what it can persist by inspecting the LEVEL HANDLES, not this
            // flag (issue #711) — a generated level stays unpersistable however the
            // group is edited, so a second, hand-maintained source of truth here
