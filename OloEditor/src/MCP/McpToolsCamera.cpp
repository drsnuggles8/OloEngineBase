    ...
    {
        {
            ...
            tool.Description =
                ...
                "Editor overlays (grid, component gizmos, world-axis helper, camera frustums, selection outline) "
                "are drawn into this frame; turn them off with olo_editor_debug_draw_set (category 'all' or one "
                "category, enabled:false) for a capture comparable with headless evidence. "
