...
#define OLO_RTR_BOOL(token, name, desc)                                                                                                                                                                                                                                               \
    FieldInfo                                                                                                                                                                                                                                                                         \
    {                                                                                                                                                                                                                                                                                 \
        token, "rtreflection", FieldType::Bool, 0.0, 1.0, {}, false, desc, &GetPpNested<&PostProcessSettings::RayTracedReflection, &RayTracedReflectionSettings::name>, &SetPpNested<&PostProcessSettings::RayTracedReflection, &RayTracedReflectionSettings::name>, nullptr, nullptr \
    }
#define OLO_RTR_NUM(token, name, type, lo, hi, desc)                                                                                                                                                                                                                     \
    FieldInfo                                                                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                                    \
