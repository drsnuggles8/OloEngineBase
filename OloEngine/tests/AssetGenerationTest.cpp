...
class StubAssetManager final : public AssetManagerBase
{
  public:
	...
	AssetType GetAssetType(AssetHandle) const noexcept override { return AssetType::None; }
	Ref<Asset> GetAsset(AssetHandle) override { return nullptr; }
	AsyncAssetResult<Asset> GetAssetAsync(AssetHandle) override { return {}; }
	AssetMetadata GetAssetMetadata(AssetHandle) const noexcept override { return {}; }
	void AddMemoryOnlyAsset(Ref<Asset>) override {}
	[[nodiscard]] bool ReloadData(AssetHandle) override { return false; }
	void ReloadDataAsync(AssetHandle) override {}
	[[nodiscard]] bool EnsureCurrent(AssetHandle) override { return true; }
	[[nodiscard]] bool EnsureAllLoadedCurrent() override { return true; }
	[[nodiscard]] bool IsAssetHandleValid(AssetHandle) const noexcept override { return false; }
	Ref<Asset> GetMemoryAsset(AssetHandle) const override { return nullptr; }
	[[nodiscard]] bool IsAssetLoaded(AssetHandle) const noexcept override { return false; }
	[[nodiscard]] bool IsAssetValid(AssetHandle) const noexcept override { return false; }
	[[nodiscard]] bool IsAssetMissing(AssetHandle) const noexcept override { return false; }
	[[nodiscard]] bool IsMemoryAsset(AssetHandle) const noexcept override { return false; }
	[[nodiscard]] bool IsPhysicalAsset(AssetHandle) const noexcept override { return false; }
	...
	std::unordered_set<AssetHandle> GetDependencies(AssetHandle) const override { return {}; }
	void SyncWithAssetThread() noexcept override {}
	std::unordered_set<AssetHandle> GetAllAssetsWithType(AssetType) const override { return {}; }
	[[nodiscard]] std::unordered_map<AssetHandle, Ref<Asset>> GetLoadedAssets() const override { return {}; }
