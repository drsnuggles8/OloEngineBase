...
namespace OloEngine::Tests
{
    namespace
    {
        ...
        // Sphere-area-light SHADOW coverage moved with the shadow-atlas rework
        // (issue #435): casting area lights are now 6-face PROJECTIVE atlas
        // entries built from the emitter centre + range (no more linear-depth
        // cubemaps and no fixed 4-slot pool). The face projection math is
        // pinned by ShadowMapTest (PointLightProduces6FaceMatrices /
        // PointFaceOrderMatchesDominantAxisSelection); the priority-ranked
        // slot assignment is pinned by ShadowAtlasPackingTest.
    } // namespace
