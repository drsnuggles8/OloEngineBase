...
namespace OloEngine
{
	...
	protected:
		...
		FMallocCrashPool& GetPool(i32 Index) { return *PoolStorage[Index].GetTypedPtr(); }
		const FMallocCrashPool& GetPool(i32 Index) const { return *PoolStorage[Index].GetTypedPtr(); }
	};
