...
ids.insert(entt::type_hash<CameraRigComponent>::value());
...
ids.insert(entt::type_hash<DiscoverableComponent>::value());
ids.insert(entt::type_hash<DiscoveredSetComponent>::value());
ids.insert(entt::type_hash<DiscoveryObjectiveMarkerComponent>::value());
ids.insert(entt::type_hash<DiscoveryReadoutComponent>::value());
...
ids.insert(entt::type_hash<FoliageInteractionComponent>::value());
ids.insert(entt::type_hash<FootIKComponent>::value());
ids.insert(entt::type_hash<GroomBindingComponent>::value());
ids.insert(entt::type_hash<GroomCoatComponent>::value());
ids.insert(entt::type_hash<GroomCoatShadowComponent>::value());
...
ids.insert(entt::type_hash<PlayerRespawnComponent>::value());
ids.insert(entt::type_hash<PlayerRigComponent>::value());
...
ids.insert(entt::type_hash<StructuralNodeComponent>::value());
...
ids.insert(entt::type_hash<WeaponComponent>::value());
