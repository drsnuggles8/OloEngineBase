...
OLO_ON_COMPONENT_REMOVED_NOOP(AnimalBudgetComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(AnimalPathComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(BoidComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(BoidObstacleComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(CameraRigComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(CloudscapeComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(ConvexMeshCollider3DComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(DebrisComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(DecalComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(DestructibleComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(DiscoverableComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(DiscoveredSetComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(DiscoveryObjectiveMarkerComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(DiscoveryReadoutComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(FoliageInteractionComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(FootIKStateComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GoapAgentComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomBindingComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomCoatComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomCoatShadowComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomFibreComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomLodComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(GroomSimulationComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(IDComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(IKTargetComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(ImpactDecalComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(PlayerRespawnComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(PlayerRigComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(ProgressionComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(ProjectileComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(SailComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(StructuralNodeComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(TilemapComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(TimeOfDayComponent)
...
OLO_ON_COMPONENT_REMOVED_NOOP(VirtualMeshComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(WaterComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(WeaponComponent)
OLO_ON_COMPONENT_REMOVED_NOOP(WeatherStateComponent)
