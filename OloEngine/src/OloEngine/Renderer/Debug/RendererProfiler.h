...
namespace OloEngine
{
    ...
    struct TIsTriviallyRelocatable<RendererProfilerFrameData>
    {
        static constexpr bool Value = TIsTriviallyRelocatable<decltype(RendererProfilerFrameData::m_FrameTime)>::Value &&
                                      ...
                                      TIsTriviallyRelocatable<decltype(RendererProfilerFrameData::m_GPUTimeStatus)>::Value &&
                                      TIsTriviallyRelocatable<decltype(RendererProfilerFrameData::m_GPUTimeFrameId)>::Value &&
                                      TIsTriviallyRelocatable<decltype(RendererProfilerFrameData::m_GPUWaitTime)>::Value &&
                                      TIsTriviallyRelocatable<decltype(RendererProfilerFrameData::m_FenceWaitTime)>::Value &&
                                      TIsTriviallyRelocatable<decltype(RendererProfilerFrameData::m_PresentWaitTime)>::Value &&
