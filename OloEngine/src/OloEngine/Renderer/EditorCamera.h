...
namespace OloEngine
{
	...
	public:
		...
		void SetViewportSize(const f32 width, const f32 height) { m_ViewportWidth = width; m_ViewportHeight = height; UpdateProjection(); }
		void SetDistance(const f32 distance) { m_Distance = distance; }
		...
		[[nodiscard("Store this!")]] const f32 GetDistance() const { return m_Distance; }
		[[nodiscard("Store this!")]] const glm::vec3& GetPosition() const { return m_Position; }
		[[nodiscard("Store this!")]] const f32 GetPitch() const { return m_Pitch; }
		[[nodiscard("Store this!")]] const f32 GetYaw() const { return m_Yaw; }
