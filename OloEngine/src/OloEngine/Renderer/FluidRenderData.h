...
namespace OloEngine
{
    ...
    {
        RHI::ResourceHandle PositionsSSBOId{};  // vec4 world positions (w = kill flag)
        RHI::ResourceHandle VelocitiesSSBOId{}; // vec4 velocities
        RHI::ResourceHandle CountersSSBOId{};   // GPUFluidCounters (live count in [0])
