...
namespace OloEngine
{
    class OrthographicCamera
    {
      public:
        ...
        [[nodiscard("Store this!")]] f32 GetRotation() const
        {
            return m_Rotation;
        }
        ...
        [[nodiscard("Store this!")]] const glm::mat4& GetProjectionMatrix() const
        {
        ...
        [[nodiscard("Store this!")]] const glm::mat4& GetViewProjectionMatrix() const
        {
