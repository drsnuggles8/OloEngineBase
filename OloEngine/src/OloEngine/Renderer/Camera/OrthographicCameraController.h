...
namespace OloEngine
{
    class OrthographicCameraController
    {
      public:
        ...
        [[nodiscard("Store this!")]] OrthographicCamera& GetCamera()
        {
            return m_Camera;
        }
        [[nodiscard("Store this!")]] const OrthographicCamera& GetCamera() const
        {
            return m_Camera;
        }

        [[nodiscard("Store this!")]] f32 GetZoomLevel() const
        {
            return m_ZoomLevel;
        }
