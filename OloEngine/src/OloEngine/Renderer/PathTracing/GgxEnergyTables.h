...
// =============================================================================
//
// C++ twin of OloEditor/assets/shaders/include/PBRClosureV2Energy.glsl — the
// SAME packed words, hex for hex, consumed by the ClosureV2 closure's
// Kulla-Conty multiple-scattering energy compensation on both sides of the
...
// values. Half quantization costs at most 2.3e-4 absolute on any entry
// (audited at generation) — an order of magnitude under every consuming
// tolerance.
//
...
//
// REGENERATION: recompute Ess with 4096 deterministic Hammersley VNDF samples
// per entry (kGgxEnergyLossAvgPacked additionally integrates 2*Ess(mu)*mu over
// a 64-point mu midpoint quadrature at 2048 samples per point), convert
// 1 - value to IEEE half (round-to-nearest-even), pack pairs low/high, and
// emit the identical hex words into both files. ClosureV2Test recomputes
// entries with the engine's own sampler (ReferenceBRDF.h) and fails if either
...
namespace OloEngine::PathTracing
{
    ...
    inline constexpr std::array<u32, 128> kGgxEnergyLossPacked = {
        0x04c5145bu, 0x00d601aeu, 0x0050007du, 0x00260036u, 0x0014001bu, 0x000a000eu, 0x00040007u, 0x00010002u,
        0x1cf6297bu, 0x1154162du, 0x08eb0f80u, 0x048f0689u, 0x02590342u, 0x013201b1u, 0x008500d1u, 0x00160048u,
        ...
        0x30f12c9au, 0x341032c0u, 0x350a349au, 0x35ae3564u, 0x361c35ebu, 0x36653644u, 0x3692367eu, 0x36ac36a1u,
