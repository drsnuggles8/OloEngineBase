...
namespace OloEngine
{
	...
	void Renderer3D::DrawMeshInstanced(const Ref<Mesh>& mesh, const std::vector<glm::mat4>& transforms, 
	...
	void Renderer3D::SetPolygonMode(unsigned int face, unsigned int mode)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetPolygonMode: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetLineWidth(float width)
	{
		...
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetLineWidth: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::EnableBlending()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::EnableBlending: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::DisableBlending()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::DisableBlending: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetBlendFunc(u32 src, u32 dest)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetBlendFunc: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetBlendEquation(unsigned int mode)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetBlendEquation: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetColorMask(bool red, bool green, bool blue, bool alpha)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetColorMask: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetDepthMask(bool enabled)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetDepthMask: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::EnableDepthTest()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::EnableDepthTest: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::DisableDepthTest()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::DisableDepthTest: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::EnableStencilTest()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::EnableStencilTest: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::DisableStencilTest()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::DisableStencilTest: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetStencilFunc(unsigned int func, int ref, unsigned int mask)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetStencilFunc: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetStencilMask(unsigned int mask)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetStencilMask: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetStencilOp(unsigned int sfail, unsigned int dpfail, unsigned int dppass)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetStencilOp: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::ClearStencil()
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::ClearStencil: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetCulling(bool enabled)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetCulling: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetCullFace(unsigned int face)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetCullFace: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetPolygonOffset(float factor, float units)
	{
		OLO_PROFILE_FUNCTION();
		
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetPolygonOffset: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::SetClearColor(const glm::vec4& color)
	{
		...
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::SetClearColor: ScenePass is null!");
			return;
		}
	...
	void Renderer3D::Clear()
	{
		...
		if (!s_Data.ScenePass)
		{
			OLO_CORE_ERROR("Renderer3D::Clear: ScenePass is null!");
			return;
		}
