...
namespace OloEngine
{
    ...
    struct WorkerSubmitContext
    {
        ...
        // nullptr for those, as for a culled mesh, so without this count
        // Statistics::ParallelSubmittedMeshes would miss a worker branch whose
        // draws all went to the overlay.
