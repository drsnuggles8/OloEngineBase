...
namespace OloEngine
{
    ...
    // Version 2 invalidates BRDF LUT cache files generated by the old
    // degenerate-quad path. Those files contained an all-zero RG32F LUT,
    // which removes the entire specular IBL term and turns fully metallic
    // materials black.
    constexpr u32 kIBLCacheVersion = 2;
