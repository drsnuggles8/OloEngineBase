...
namespace OloEngine
{
    ...
    void VignetteRenderPass::Setup(RGBuilder& builder, FrameBlackboard& blackboard)
    {
        ...
        if (blackboard.VignetteColor.IsValid())
        {
            ...
            SetPrimaryOutputTextureHandle(
                builder.CreateFramebufferAttachmentView(std::string(ResourceNames::VignetteColorTexture) + "@" +
                                                            std::string(vignetteVersionTag),
                                                        outputHandle,
                                                        0u));
        }
    }
