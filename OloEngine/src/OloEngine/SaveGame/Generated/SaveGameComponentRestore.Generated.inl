...
TRY_LOAD_COMPONENT(CameraRigComponent);
...
TRY_LOAD_COMPONENT(DiscoverableComponent);
TRY_LOAD_COMPONENT(DiscoveredSetComponent);
TRY_LOAD_COMPONENT(DiscoveryObjectiveMarkerComponent);
TRY_LOAD_COMPONENT(DiscoveryReadoutComponent);
TRY_LOAD_COMPONENT(EnvironmentMapComponent);
TRY_LOAD_COMPONENT(FluidComponent);
TRY_LOAD_COMPONENT(FluidEmitterComponent);
...
TRY_LOAD_COMPONENT(LocomotionComponent);
...
TRY_LOAD_COMPONENT(PlayerRespawnComponent);
TRY_LOAD_COMPONENT(PlayerRigComponent);
...
TRY_LOAD_COMPONENT(WeaponComponent);
