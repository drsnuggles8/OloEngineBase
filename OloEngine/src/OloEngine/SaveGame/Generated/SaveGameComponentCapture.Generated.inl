...
SAVE_COMPONENT(CameraRigComponent, entity, writer);
...
SAVE_COMPONENT(DiscoverableComponent, entity, writer);
SAVE_COMPONENT(DiscoveredSetComponent, entity, writer);
SAVE_COMPONENT(DiscoveryObjectiveMarkerComponent, entity, writer);
SAVE_COMPONENT(DiscoveryReadoutComponent, entity, writer);
...
SAVE_COMPONENT(GroomCoatComponent, entity, writer);
SAVE_COMPONENT(GroomCoatShadowComponent, entity, writer);
...
SAVE_COMPONENT(PlayerRespawnComponent, entity, writer);
SAVE_COMPONENT(PlayerRigComponent, entity, writer);
...
SAVE_COMPONENT(WeaponComponent, entity, writer);
