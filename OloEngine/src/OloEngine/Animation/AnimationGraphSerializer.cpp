...
namespace OloEngine
{
	...
	{
		if (str == "Int")     return AnimationParameterType::Int;
		if (str == "Bool")    return AnimationParameterType::Bool;
		if (str == "Trigger") return AnimationParameterType::Trigger;
	...
	static std::string ComparisonToString(TransitionCondition::Comparison op)
	{
		switch (op)
		{
		case TransitionCondition::Comparison::Greater:    return "Greater";
		case TransitionCondition::Comparison::Less:       return "Less";
		case TransitionCondition::Comparison::Equal:      return "Equal";
		case TransitionCondition::Comparison::NotEqual:   return "NotEqual";
		case TransitionCondition::Comparison::TriggerSet: return "TriggerSet";
		}
		return "Greater";
	}
	...
	{
		if (str == "Less")       return TransitionCondition::Comparison::Less;
		if (str == "Equal")      return TransitionCondition::Comparison::Equal;
		if (str == "NotEqual")   return TransitionCondition::Comparison::NotEqual;
		if (str == "TriggerSet") return TransitionCondition::Comparison::TriggerSet;
	...
	static std::string BlendTypeToString(BlendTree::BlendType type)
	{
		switch (type)
		{
		case BlendTree::BlendType::Simple1D:               return "Simple1D";
		case BlendTree::BlendType::SimpleDirectional2D:    return "SimpleDirectional2D";
		case BlendTree::BlendType::FreeformDirectional2D:  return "FreeformDirectional2D";
		case BlendTree::BlendType::FreeformCartesian2D:    return "FreeformCartesian2D";
		}
		return "Simple1D";
	}
	...
	{
		if (str == "SimpleDirectional2D")   return BlendTree::BlendType::SimpleDirectional2D;
		if (str == "FreeformDirectional2D") return BlendTree::BlendType::FreeformDirectional2D;
		if (str == "FreeformCartesian2D")   return BlendTree::BlendType::FreeformCartesian2D;
	...
	static std::string BlendModeToString(AnimationLayer::BlendMode mode)
	{
		switch (mode)
		{
		case AnimationLayer::BlendMode::Override: return "Override";
		case AnimationLayer::BlendMode::Additive: return "Additive";
		}
		return "Override";
	}
	...
	{
		if (str == "Additive") return AnimationLayer::BlendMode::Additive;
