...
#define OLO_ENABLE_ALLOCATION_TRACKING 0
    ...
    class AllocationTracker
    {
      ...
      private:
        ...
        template<class T>
        friend class AllocationTrackerExtended;
        template<class T>
        friend class AllocationSnapshot;
    };
    ...
    class AllocationTracker
    {
      public:
         ...
         */
        static constexpr sizet GetLiveCount() noexcept
        {
            return 0;
        }
         ...
         * @brief Always returns 0 in release builds
         */
        static constexpr sizet GetPeakCount() noexcept
        {
            return 0;
        }
         ...
         * @brief Always returns 0 in release builds
         */
        static constexpr sizet GetTotalCreated() noexcept
        {
            return 0;
        }
        ...
        static std::string GetStatsString()
        {
            return "Tracking disabled (release build)";
        }
    };
...
#define OLO_ALLOCATION_TRACKED(ClassName) \
  public                                  \
    ::OloEngine::AllocationTracker<ClassName>
#else
#define OLO_ALLOCATION_TRACKED(ClassName)
#endif
...
#define OLO_TRACKED_REFCOUNTED(ClassName) \
  public                                  \
    ::OloEngine::RefCounted, public ::OloEngine::AllocationTracker<ClassName>
#else
#define OLO_TRACKED_REFCOUNTED(ClassName) \
  public                                  \
    ::OloEngine::RefCounted
#endif
