...
namespace OloEngine
{
    ...
    namespace ETypeLayoutInterface
    {
        ...
        [[nodiscard]] OLO_FINLINE bool HasVTable(Type InType)
        {
            return InType != NonVirtual;
        }
    } // namespace ETypeLayoutInterface
    ...
    namespace EFieldLayoutFlags
    {
        ...
        [[nodiscard]] OLO_FINLINE Type MakeFlags(u32 Flags = None)
        {
            return static_cast<Type>(Flags);
        }
        [[nodiscard]] OLO_FINLINE Type MakeFlagsEditorOnly(u32 Flags = None)
        {
            return static_cast<Type>(WithEditorOnly | Flags);
        }
        [[nodiscard]] OLO_FINLINE Type MakeFlagsRayTracing(u32 Flags = None)
        {
            return static_cast<Type>(WithRayTracing | Flags);
        }
    } // namespace EFieldLayoutFlags
    ...
    struct FPlatformTypeLayoutParameters
    {
        ...
        {
            return (FlagsValue & Flag_Initialized) != 0u;
        }
        [[nodiscard]] bool Is32Bit() const
        {
            return (FlagsValue & Flag_Is32Bit) != 0u;
        }
        [[nodiscard]] bool HasAlignBases() const
        {
            return (FlagsValue & Flag_AlignBases) != 0u;
        }
        [[nodiscard]] bool WithEditorOnly() const
        {
            return (FlagsValue & Flag_WithEditorOnly) != 0u;
        }
        [[nodiscard]] u32 GetRawPointerSize() const
        {
            return Is32Bit() ? sizeof(u32) : sizeof(u64);
        }
    };
    ...
    template<>
    struct THasTypeLayout<bool>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<char>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<signed char>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<short>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<int>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<long>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<long long>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<unsigned char>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<unsigned short>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<unsigned int>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<unsigned long>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<unsigned long long>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<float>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<double>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<wchar_t>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<char16_t>
    {
        static constexpr bool Value = true;
    };
    template<>
    struct THasTypeLayout<void*>
    {
        static constexpr bool Value = true;
    };
    ...
    {
        static FWriteFrozenMemoryImageFunc* Do()
        {
            return &Freeze::DefaultWriteMemoryImage;
        }
    };
    ...
    {
        static FFieldLayoutDesc::FWriteFrozenMemoryImageFunc* Do()
        {
            return &Freeze::DefaultWriteMemoryImageField;
        }
    };
...
#define UE_DECLARE_INTERNAL_LINK_BASE(Name) template<int Counter> \
struct Name
#define UE_DECLARE_INTERNAL_LINK_SPECIALIZATION(Name, Counter) template<> \
struct Name<Counter>
...
#define INTERNAL_DECLARE_TYPE_LAYOUT_COMMON(T, InInterface)                                                              \
  ...
  public:                                                                                                                \
    ...
    {                                                                                                                    \
        ...
        static void Initialize(OloEngine::FTypeLayoutDesc & TypeDesc)                                                    \
        {                                                                                                                \
            (void)TypeDesc;                                                                                              \
        }                                                                                                                \
    }
...
#define INTERNAL_DECLARE_LAYOUT_BASE(T)                                                         \
  private:                                                                                      \
    using InternalBaseType = typename OloEngine::TGetBaseTypeHelper<T>::Type;                   \
    template<typename InternalType>                                                             \
    static void InternalInitializeBases(OloEngine::FTypeLayoutDesc& TypeDesc)                   \
    {                                                                                           \
        OloEngine::TInitializeBaseHelper<InternalType, InternalBaseType>::Initialize(TypeDesc); \
    }
...
#define DECLARE_INLINE_TYPE_LAYOUT(T, InInterface)                                                                                                                \
    INTERNAL_DECLARE_LAYOUT_BASE(T);                                                                                                                              \
                                                                                                                                                                  \
  private:                                                                                                                                                        \
    static void InternalDestroy(void* Object, const OloEngine::FTypeLayoutDesc&, const OloEngine::FPointerTableBase* PtrTable, bool bIsFrozen)                    \
    {                                                                                                                                                             \
        OloEngine::Freeze::DestroyObject(static_cast<T*>(Object), PtrTable, bIsFrozen);                                                                           \
    }                                                                                                                                                             \
                                                                                                                                                                  \
  public:                                                                                                                                                         \
    static OloEngine::FTypeLayoutDesc& StaticGetTypeLayout()                                                                                                      \
    {                                                                                                                                                             \
        ...
        return TypeDesc;                                                                                                                                          \
                                                                                                                                                                  ...
                                                                                                                                                                  \
  public:                                                                                                                                                         \
    const OloEngine::FTypeLayoutDesc& GetTypeLayout() const                                                                                                       \
    {                                                                                                                                                             \
...
#define DECLARE_EXPORTED_TYPE_LAYOUT(T, RequiredAPI, Interface)                                                                                 \
  ...
  private:                                                                                                                                      \
    static void InternalDestroy(void* Object, const OloEngine::FTypeLayoutDesc&, const OloEngine::FPointerTableBase* PtrTable, bool bIsFrozen); \
                                                                                                                                                \
  public:                                                                                                                                       \
    RequiredAPI static OloEngine::FTypeLayoutDesc& StaticGetTypeLayout();                                                                       \
                                                                                                                                                \
  public:                                                                                                                                       \
    RequiredAPI const OloEngine::FTypeLayoutDesc& GetTypeLayout() const;                                                                        \
    INTERNAL_DECLARE_TYPE_LAYOUT_COMMON(T, Interface)
...
#define IMPLEMENT_TYPE_LAYOUT(T)                                                                                                           \
    ...
    const OloEngine::FTypeLayoutDesc& T::GetTypeLayout() const                                                                             \
    {                                                                                                                                      \
        return StaticGetTypeLayout();                                                                                                      \
    }
