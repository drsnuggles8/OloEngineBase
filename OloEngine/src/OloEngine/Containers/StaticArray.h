    ...
    class TStaticArray
    {
      public:
        ...
        [[nodiscard]] constexpr explicit TStaticArray(EInPlace, ArgTypes&&... Args)
            : TStaticArray{ InPlace, TMakeIntegerSequence<u32, NumElements>(), [&Args...](u32)
                            { return InElementType(Args...); } }
        {
        }
        ...
        [[nodiscard]] constexpr TStaticArray(ArgTypes&&... Args)
            : TStaticArray{ PerElement, [&Args]
                            { return InElementType(Forward<ArgTypes>(Args)); }... }
        {
        }
        ...
        [[nodiscard]] constexpr InElementType* begin()
        {
            return Elements;
        }
        [[nodiscard]] constexpr const InElementType* begin() const
        {
            return Elements;
        }
        [[nodiscard]] constexpr InElementType* end()
        {
            return Elements + NumElements;
        }
        [[nodiscard]] constexpr const InElementType* end() const
        {
            return Elements + NumElements;
        }
        [[nodiscard]] constexpr TReversePointerIterator<InElementType> rbegin()
        {
            return TReversePointerIterator<InElementType>(Elements + NumElements);
        }
        [[nodiscard]] constexpr TReversePointerIterator<const InElementType> rbegin() const
        {
            return TReversePointerIterator<const InElementType>(Elements + NumElements);
        }
        [[nodiscard]] constexpr TReversePointerIterator<InElementType> rend()
        {
            return TReversePointerIterator<InElementType>(Elements);
        }
        [[nodiscard]] constexpr TReversePointerIterator<const InElementType> rend() const
        {
            return TReversePointerIterator<const InElementType>(Elements);
        }
