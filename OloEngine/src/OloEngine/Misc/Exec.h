...
#define OLO_ALLOW_EXEC_EDITOR OLO_ALLOW_EXEC_COMMANDS
    ...
    class FExec
    {
      ...
      protected:
        ...
        virtual bool Exec_Runtime(const char* Cmd, FOutputDevice& Ar)
        {
            (void)Cmd;
            (void)Ar;
            return false;
        ...
        virtual bool Exec_Dev(const char* Cmd, FOutputDevice& Ar)
        {
            (void)Cmd;
            (void)Ar;
            return false;
        ...
        virtual bool Exec_Editor(const char* Cmd, FOutputDevice& Ar)
        {
            (void)Cmd;
            (void)Ar;
            return false;
