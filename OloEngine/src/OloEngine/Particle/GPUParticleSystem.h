...
namespace OloEngine
{
	...
	public:
		...
		[[nodiscard]] const Ref<StorageBuffer>& GetParticleSSBO() const { return m_ParticleSSBO; }
		[[nodiscard]] const Ref<StorageBuffer>& GetAliveIndexSSBO() const { return m_AliveIndexSSBO; }
		[[nodiscard]] const Ref<StorageBuffer>& GetIndirectDrawSSBO() const { return m_IndirectDrawSSBO; }
