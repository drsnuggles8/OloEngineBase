...
namespace OLO
{
	...
	public:
		...
		u32 GetRefCount() const { return m_RefCount.load(std::memory_order_relaxed); }
	...
	public:
		...
		IQueuedWorkInternalData* Get() const { return m_Ptr; }
		IQueuedWorkInternalData* operator->() const { return m_Ptr; }
	...
	public:
		 ...
		 */
		virtual i64 GetRequiredMemory() const { return -1; }
