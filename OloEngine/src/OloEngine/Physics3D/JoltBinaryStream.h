...
namespace OloEngine
{
    ...
    class JoltBinaryStreamReader
    {
      public:
        ...
        [[nodiscard]] u64 GetBytesRead() const
        {
            return m_ReadBytes;
        }
    ...
    class JoltBinaryStreamWriter
    {
      public:
        ...
        [[nodiscard]] const u8* GetDataPtr() const
        {
        ...
        [[nodiscard]] sizet GetCapacity() const
        {
            return m_TempBuffer.capacity();
        }
        void ShrinkToFit()
        {
            m_TempBuffer.shrink_to_fit();
        }
