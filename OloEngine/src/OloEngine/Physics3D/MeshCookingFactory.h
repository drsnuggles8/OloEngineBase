...
namespace OloEngine
{
    ...
    class MeshCookingFactory : public RefCounted
    {
      public:
        ...
        // Settings
        void SetVertexWeldingEnabled(bool enabled)
        {
            m_VertexWeldingEnabled = enabled;
        }
        bool IsVertexWeldingEnabled() const
        {
            return m_VertexWeldingEnabled;
        }

        void SetVertexWeldTolerance(f32 tolerance)
        {
            m_VertexWeldTolerance = tolerance;
        }
        f32 GetVertexWeldTolerance() const
        {
            return m_VertexWeldTolerance;
        }

        void SetMaxConvexHullVertices(u32 maxVertices)
        {
            m_MaxConvexHullVertices = maxVertices;
        }
        u32 GetMaxConvexHullVertices() const
        {
            return m_MaxConvexHullVertices;
        }

        void SetMaxConvexRadius(f32 radius)
        {
            m_MaxConvexRadius = radius;
        }
        f32 GetMaxConvexRadius() const
        {
            return m_MaxConvexRadius;
        }

        // Statistics
        sizet GetTriangleMeshCount() const
        {
            return m_TriangleMeshCount;
        }
        sizet GetConvexMeshCount() const
        {
            return m_ConvexMeshCount;
        }
        sizet GetCachedMeshCount() const
        {
            return m_CachedMeshCount;
        }
