...
namespace OloEngine
{
    ...
    {
        None = 0,
        TranslationX = OloBit32(0),
        TranslationY = OloBit32(1),
        TranslationZ = OloBit32(2),
        Translation = TranslationX | TranslationY | TranslationZ,
        RotationX = OloBit32(3),
        RotationY = OloBit32(4),
        RotationZ = OloBit32(5),
