...
namespace OloEngine
{
    ...
    class JoltCharacterController : public RefCounted, public JPH::CharacterContactListener
    {
      public:
        ...
        void SetControlMovementInAir(bool controlMovementInAir)
        {
            m_ControlMovementInAir = controlMovementInAir;
        }
        bool CanControlMovementInAir() const
        {
            return m_ControlMovementInAir;
        }
        void SetControlRotationInAir(bool controlRotationInAir)
        {
            m_ControlRotationInAir = controlRotationInAir;
        }
        bool CanControlRotationInAir() const
        {
            return m_ControlRotationInAir;
        }

        // Collision information
        ECollisionFlags GetCollisionFlags() const
        {
        ...
        // Collision filtering
        void SetIgnoreCollisionLayers(u32 layerMask)
        {
            m_IgnoreCollisionLayers = layerMask;
        }
        u32 GetIgnoreCollisionLayers() const
        {
            return m_IgnoreCollisionLayers;
        }

        // Internal Jolt access
        JPH::BodyID GetBodyID() const
        {
            return m_Controller ? m_Controller->GetInnerBodyID() : JPH::BodyID();
        }
        JPH::CharacterVirtual* GetJoltController() const
        {
            return m_Controller.GetPtr();
        }
