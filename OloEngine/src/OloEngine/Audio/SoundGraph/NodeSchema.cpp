...
namespace OloEngine::Audio::SoundGraph
{
    ...
    namespace
    {
        ...
        const std::unordered_map<std::string, NodePinSchema>& GetPinSchemaMap()
        {
            ...
            auto val = [](const char* name) { return NodePinDescriptor{ name, false }; };
            auto ev  = [](const char* name) { return NodePinDescriptor{ name, true }; };

            static const std::unordered_map<std::string, NodePinSchema> s_Pins = {
                // ----- WavePlayer ---------------------------------------------------
                { "WavePlayer", {
                    /* Inputs */  { ev("Play"), ev("Stop"),
                                    val("WaveAsset"), val("StartTime"), val("Loop"), val("NumberOfLoops") },
                    /* Outputs */ { val("OutLeft"), val("OutRight"),
                                    ev("OnPlay"), ev("OnStop"), ev("OnFinished") },
                }},
                ...
                { "ADEnvelope",          {
                    /* Inputs */  { ev("s_Trigger"),
                                    val("AttackTime"), val("DecayTime"),
                                    val("AttackCurve"), val("DecayCurve"), val("Looping") },
                    /* Outputs */ { val("OutEnvelope"), ev("OnTrigger"), ev("OnComplete") },
                }},
                { "ADSREnvelope",        {
                    /* Inputs */  { ev("s_Trigger"), ev("s_Release"),
                                    val("AttackTime"), val("DecayTime"), val("SustainLevel"), val("ReleaseTime"),
                                    val("AttackCurve"), val("DecayCurve"), val("ReleaseCurve") },
                ...
                { "TriggerCounter",      {
                    /* Inputs */  { ev("s_Trigger"), ev("s_Reset"),
                                    val("StartValue"), val("StepSize"), val("ResetCount") },
