...
{
	//==============================================================================
	/// LowPassFilterNode - Simple one-pole low-pass filter
	/// Implements a basic RC-style low-pass filter
	class LowPassFilterNode : public NodeProcessor
	{
	...
	public:
		...
		void Process(f32** inputs, f32** outputs, u32 numSamples) override
		{
			...
			// Clamp cutoff to reasonable range (avoid aliasing)
			...
			// Calculate filter coefficients (simple one-pole)
		...
		{
			return OLO_IDENTIFIER("LowPassFilterNode");
		}
