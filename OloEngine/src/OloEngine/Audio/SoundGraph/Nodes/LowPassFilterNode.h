...
{
	//==============================================================================
	/// LowPassFilterNode - Simple one-pole low-pass filter using new Hazel-style foundation
	/// Implements a basic RC-style low-pass filter with controllable cutoff and resonance
