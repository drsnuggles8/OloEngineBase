...
namespace OloEngine::Colors
{
    // Centralized theme color palette.
    // To experiment with editor theme live, change these constexpr into static
    // members and add a quick ImGui window to adjust the colour values.
    namespace Theme
    {
        constexpr auto accent = IM_COL32(236, 158, 36, 255);
        constexpr auto highlight = IM_COL32(39, 185, 242, 255);
        constexpr auto niceBlue = IM_COL32(83, 232, 254, 255);
        constexpr auto complement = IM_COL32(78, 151, 166, 255);
