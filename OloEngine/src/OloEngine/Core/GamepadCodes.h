...
namespace OloEngine
{
    ...
    {
        if (str == "South")       return GamepadButton::South;
        if (str == "East")        return GamepadButton::East;
        if (str == "West")        return GamepadButton::West;
        if (str == "North")       return GamepadButton::North;
