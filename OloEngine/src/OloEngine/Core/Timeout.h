    ...
    class FTimeout
    {
      public:
        ...
        friend bool operator==(FTimeout Left, FTimeout Right)
        {
            ...
            return Left.TimeoutCycles == Right.TimeoutCycles && (Left.WillNeverExpire() || Left.IsAlwaysExpired() || Left.StartCycles == Right.StartCycles);
        }
      ...
      private:
        FTimeout(u64 StartValue, u64 TimeoutValue)
            : StartCycles(StartValue), TimeoutCycles(TimeoutValue)
        {
        }
