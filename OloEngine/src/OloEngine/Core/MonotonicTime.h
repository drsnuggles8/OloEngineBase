...
namespace OloEngine
{
	...
	public:
		...
		constexpr static FMonotonicTimeSpan Infinity() { return FromSeconds(std::numeric_limits<f64>::infinity()); }
		...
		constexpr static FMonotonicTimeSpan FromMilliseconds(f64 Milliseconds) { return FromSeconds(Milliseconds * 0.001); }

		constexpr f64 ToSeconds() const { return m_Time; }
		constexpr f64 ToMilliseconds() const { return m_Time * 1000.0; }

		constexpr bool IsZero() const { return *this == Zero(); }
		constexpr bool IsInfinity() const { return *this == Infinity(); }
		bool IsNaN() const { return std::isnan(m_Time); }

		constexpr bool operator==(const FMonotonicTimeSpan Other) const { return m_Time == Other.m_Time; }
		constexpr bool operator!=(const FMonotonicTimeSpan Other) const { return m_Time != Other.m_Time; }
		constexpr bool operator<=(const FMonotonicTimeSpan Other) const { return m_Time <= Other.m_Time; }
		constexpr bool operator< (const FMonotonicTimeSpan Other) const { return m_Time <  Other.m_Time; }
		constexpr bool operator>=(const FMonotonicTimeSpan Other) const { return m_Time >= Other.m_Time; }
		...
		constexpr FMonotonicTimeSpan operator-() const { return FromSeconds(-m_Time); }

		constexpr FMonotonicTimeSpan operator+(const FMonotonicTimeSpan Span) const { return FromSeconds(m_Time + Span.m_Time); }
		constexpr FMonotonicTimeSpan operator-(const FMonotonicTimeSpan Span) const { return FromSeconds(m_Time - Span.m_Time); }
	...
	public:
		...
		constexpr static FMonotonicTimePoint Infinity() { return FromSeconds(std::numeric_limits<f64>::infinity()); }
		...
		constexpr bool operator==(const FMonotonicTimePoint Other) const { return m_Time == Other.m_Time; }
		constexpr bool operator!=(const FMonotonicTimePoint Other) const { return m_Time != Other.m_Time; }
		constexpr bool operator<=(const FMonotonicTimePoint Other) const { return m_Time <= Other.m_Time; }
		constexpr bool operator< (const FMonotonicTimePoint Other) const { return m_Time <  Other.m_Time; }
		constexpr bool operator>=(const FMonotonicTimePoint Other) const { return m_Time >= Other.m_Time; }
		...
		constexpr FMonotonicTimePoint operator+(const FMonotonicTimeSpan Span) const { return FromSeconds(m_Time + Span.ToSeconds()); }
		constexpr FMonotonicTimePoint operator-(const FMonotonicTimeSpan Span) const { return FromSeconds(m_Time - Span.ToSeconds()); }
