...
namespace OloEngine
{
	...
	public:
		...
		constexpr operator u32() const noexcept { return m_Hash; }

		//==============================================================================
		/// Getters
		constexpr u32 GetHash() const noexcept { return m_Hash; }
		constexpr bool IsValid() const noexcept { return m_Hash != 0; }

		//==============================================================================
		/// Static helpers
		static constexpr Identifier Invalid() noexcept { return Identifier(0); }
	...
	#define DECLARE_IDENTIFIER(name) \
		static constexpr ::OloEngine::Identifier name{ #name }
