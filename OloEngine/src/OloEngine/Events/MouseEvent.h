...
namespace OloEngine
{
    class MouseMovedEvent : public Event
    {
      public:
        ...
        [[nodiscard("Store this!")]] f32 GetX() const
        {
            return m_MouseX;
        }
        [[nodiscard("Store this!")]] f32 GetY() const
        {
            return m_MouseY;
        }
    ...
    class MouseScrolledEvent : public Event
    {
      public:
        ...
        [[nodiscard("Store this!")]] f32 GetXOffset() const
        {
            return m_XOffset;
        }
        [[nodiscard("Store this!")]] f32 GetYOffset() const
        {
            return m_YOffset;
        }
    ...
    {
      public:
        [[nodiscard("Store this!")]] MouseCode GetMouseButton() const
        {
            return m_Button;
        }
