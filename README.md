...
documented in that file's header comment — briefly: entt, glm and Tracy are ahead of what the registry
carries, ImGuizmo's port would drag in a second Dear ImGui, stb's port is ~2 years behind on an image
...
**Development & profiling** — [tracy](https://github.com/wolfpld/tracy) (**in-tree**) · [googletest](https://github.com/google/googletest) · [filewatch](https://github.com/ThomasMonkman/filewatch) (**in-tree**)
