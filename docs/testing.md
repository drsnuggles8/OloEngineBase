...
| [AnimationRetargetTest.cpp](../OloEngine/tests/Animation/AnimationRetargetTest.cpp) | 10 | **AnimationRetarget** &mdash; `NormalizeBoneNameCollapsesCommonVariants`, `BuildByNameResolvesExactAndNormalized`, `BuildByNamePrefersExactOverNormalizedCollision`, `BuildByNameIgnoresEmptyNormalizedNames`, `RetargetLocalPosePreservesTargetProportions`, `RetargetLocalPoseRebasesDifferingRestOrientations`, `RetargetLocalPoseTransfersScaledRootTranslation`, `RetargetClipDrivesTargetSkeletonViaAnimationSystem`, `RetargetClipReturnsNullForNullSource`, `ComputeRootTranslationScaleFromRigExtents` |
