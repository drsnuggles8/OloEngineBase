...
**Totals.** 89 Functional test files, 144 TEST / TEST_F declarations across all subsystems.
...
| [InterestManagerTest.cpp](../OloEngine/tests/Networking/InterestManagerTest.cpp) | 11 | **InterestManagerTest** &mdash; `EntitiesWithoutInterestComponentAreAlwaysRelevant`, `ZeroRadiusIsAlwaysRelevant`, `DistanceFilteringWorks`, `GroupFilteringWorks`, `DefaultGroupIsAlwaysIncluded`, `NonReplicatedEntitiesAreExcluded`, `IsEntityRelevantMatchesGetRelevantEntities`, `GridFilteredResultsMatchFullScan`, `GridMatchesFullScanAcrossClientPositions`, `HugeRelevanceRadiusFallsBackToFullScanCorrectly`, `IsEntityRelevantAgreesWithGetRelevantEntities` |
...
**Totals.** 147 unit / subsystem test files, 1817 TEST / TEST_F declarations across all subsystems.
