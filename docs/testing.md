...
| [ScreenSpaceReflectionMathTest.cpp](../OloEngine/tests/Rendering/ScreenSpaceReflectionMathTest.cpp) | 10 | **ScreenSpaceReflection** &mdash; `SSRUBOAlignment`, `SSRUBOGetSizeMatchesSizeof`, `SSRBindingIsUniqueAndExpected`, `ViewPositionProjectRoundTrip`, `OctahedralNormalRoundTrip`, `ReflectionVectorIsMirroredAcrossNormal`, `FresnelSchlickEndpointsAndMonotonicity`, `RoughnessFadeCutoff`, `EdgeFadeVanishesAtBorders`, `SanitizeClampsNonFiniteAndRanges` |
