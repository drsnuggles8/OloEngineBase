...
| [AnimationRetargetTest.cpp](../OloEngine/tests/Animation/AnimationRetargetTest.cpp) | 9 | **AnimationRetarget** &mdash; `NormalizeBoneNameCollapsesCommonVariants`, `BuildByNameResolvesExactAndNormalized`, `BuildByNamePrefersExactOverNormalizedCollision`, `RetargetLocalPosePreservesTargetProportions`, `RetargetLocalPoseRebasesDifferingRestOrientations`, `RetargetLocalPoseTransfersScaledRootTranslation`, `RetargetClipDrivesTargetSkeletonViaAnimationSystem`, `RetargetClipReturnsNullForNullSource`, `ComputeRootTranslationScaleFromRigExtents` |
