...
**Totals.** 74 renderer-scope test files, 1156 TEST / TEST_F / TEST_P declarations across all layers.
...
**Totals.** 76 Functional test files, 79 TEST / TEST_F declarations across all subsystems.
...
| [MathTest.cpp](../OloEngine/tests/MathTest.cpp) | 8 | **MathBitwiseEqualTest** &mdash; `EqualScalarsCompareEqual`, `DifferentScalarsCompareUnequal`, `PositiveAndNegativeZeroAreDistinct`, `NaNIsBitwiseEqualToItself`, `DifferentNaNPayloadsAreUnequal`, `GlmVecComparison`, `GlmMat4Comparison`, `IntegerTypesAlsoWork` |
...
| [ZoneHandoffTest.cpp](../OloEngine/tests/Networking/ZoneHandoffTest.cpp) | 6 | **PlayerStatePacket** &mdash; `SerializeDeserializeRoundtrip`, `EmptyGameStateBlob`<br/>**ZoneHandoff** &mdash; `ThreePhaseHandoffProtocol`, `HandoffRejectionOnFull`, `GhostEntityVisibility`, `PlayerTransitioningState` |
