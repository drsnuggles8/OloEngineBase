...
| [AnimationRetargetTest.cpp](../OloEngine/tests/Animation/AnimationRetargetTest.cpp) | 11 | **AnimationRetarget** &mdash; `NormalizeBoneNameCollapsesCommonVariants`, `BuildByNameResolvesExactAndNormalized`, `BuildByNamePrefersExactOverNormalizedCollision`, `BuildByNameIgnoresEmptyNormalizedNames`, `SetBoneMappingNormalizesInvalidNegative`, `RetargetLocalPosePreservesTargetProportions`, `RetargetLocalPoseRebasesDifferingRestOrientations`, `RetargetLocalPoseTransfersScaledRootTranslation`, `RetargetClipDrivesTargetSkeletonViaAnimationSystem`, `RetargetClipReturnsNullForNullSource`, `ComputeRootTranslationScaleFromRigExtents` |
...
**Totals.** 152 unit / subsystem test files, 1883 TEST / TEST_F declarations across all subsystems.
