...
## 0. Adding or changing a component: every touch-point

The pre-commit hook cannot catch these. Most are generated by OloHeaderTool from every
`struct *Component` definition; the right-hand column is what is still yours.
