...
| [transparent-draw-order.md](transparent-draw-order.md) | An inverted depth in the LEAST significant field orders blended draws only within one shader+material bucket; across materials they composited in material-ID order, and the wrong blend still looks like a blend. |
