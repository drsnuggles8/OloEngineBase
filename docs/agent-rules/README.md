...
- [groom-card-coverage.md](groom-card-coverage.md): cook a card as wide as its members cover, never their sum; bake its self-shadow at each group's fibre area; give it its members' mean jitter; draw a ribbon at its fibre's front surface; measure a hand-over in linear quantities, apart, on a frozen pose.
