...
| `vcpkg-Windows-x64-windows-static-md` | **1448 MiB measured** 2026-09-13 under #1205's new key shape — up from **706 MiB** on 2026-09-09 (692 on 2026-09-06), and the doubling is **not measured**: #1205 started a fresh lineage keyed on the runner image as well as the manifest, and a fresh lineage is normally *smaller* (see the ASan Windows row). State it as an observation, not a cause. A **second, stranded 756 MiB entry** in the old spelling sat beside it until the prefix-strip fix below. |
| `vcpkg-Linux-x64-linux` | **327 MiB measured** 2026-09-13, unchanged from 2026-09-09 — but **two live entries, 654 MiB**, for the same reason as the Windows row: #1205's image stamp started a new lineage and the predecessor was stranded. |
...
| **measured subtotal** | **2686 MiB** (4 + 10 + 256 + 314 + 654 + 1448), measured 2026-09-13. Was **1813 MiB** (4 + 229 + 256 + 291 + 327 + 706) on 2026-09-09; +873 MiB, of which +742 is the unexplained vcpkg-Windows growth and +327 the stranded Linux vcpkg generation. |
