...
namespace OloEngine {
	...
	void EditorLayer::OnUpdate(OloEngine::Timestep ts)
	{
		OLO_PROFILE_FUNCTION();

		// Resize
		if (OloEngine::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
	...
	void EditorLayer::OnEvent(OloEngine::Event& e)
	{
