...
Sandbox3D::Sandbox3D()
	: Layer("Sandbox3D"), m_CameraController(1280.0f / 720.0f), m_RotationAngleY(0.0f), m_RotationAngleX(0.0f)
{
}
...
void Sandbox3D::OnUpdate(const OloEngine::Timestep ts)
{
	...
	OloEngine::Renderer3D::BeginScene(m_CameraController.GetCamera().GetViewProjectionMatrix());
